...
namespace Landis.Extension.Scrapple
{
    ...
    public interface IInputParameters
    {
        ...
        int RxFirstDayFire_2 {get; set; }
        int RxLastDayFire_2 {get; set; }
...
namespace Landis.Extension.Scrapple
{
        ...
        : IInputParameters
    {
        ...
        private int lastDayRx;
                       // KJ + KM add bimodal rx fire 
        private int firstDayRx_2;
        private int lastDayRx_2;
