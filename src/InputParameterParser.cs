        ...
        : TextParser<IInputParameters>
    {
        ...
        protected override IInputParameters Parse()
        {
            ...
            parameters.RxLastDayFire = last_rx_day.Value;
                        ...
                        // KJ + KM add bimodal rx fire 
            InputVar<int> first_rx_day_2 = new InputVar<int>("FirstDayRxFires_2");
            ReadVar(first_rx_day_2);
            parameters.RxFirstDayFire_2 = first_rx_day_2.Value;

            InputVar<int> last_rx_day_2 = new InputVar<int>("LastDayRxFires_2");
            ReadVar(last_rx_day_2);
            parameters.RxLastDayFire_2 = last_rx_day_2.Value;
